    ...
    return (
        <>
                                ...
                                cryptoData.map((data) => {
                                    return (
                                        <tr key={data.id} className=' text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0 '>
                                            <td className='py-4 flex justify-between  items-center uppercase' >
                                                ...
                                                <img className=' w-[3rem]  mx-1.5 ' src={data.image} alt={data.name} />
                                            ...
                                            <td className='py-4' >{Number(data.market_cap_change_percentage_24h).toFixed(4)}%</td>
                                            <td className={
                                                data.price_change_percentage_1h_in_currency > 0 ? 'text-green py-4' : 'text-red py-4'
                                            } >{Number(data.price_change_percentage_1h_in_currency).toFixed(3)}</td>
                                            <td className={
            ...
            <div className='flex items-center justify-between mt-4 capitalize h-[2rem]'>
                <span > Data Provided by <a href="http://coingecko.com" rel='noreferrer' target={'_blank'} className='text-cyan'>Coingecko</a></span>
                <Pagination />
            </div>
        </>
    )
